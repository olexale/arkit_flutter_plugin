...
| Load .gltf .glb | Load .gltf or .glb in the flutter assets or documents folder of the current app | [code](https://github.com/olexale/arkit_flutter_plugin/blob/master/example/lib/load_gltf_or_glb_page.dart) | |
