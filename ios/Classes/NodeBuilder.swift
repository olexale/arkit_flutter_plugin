...
fileprivate func createNodeWithGltfOrGlbFile(_ dict: Dictionary<String, Any>) -> SCNNode {
    var scene: SCNScene
    let node: SCNNode = SCNNode()
    let assetType = dict["assetType"] as! String
...
fileprivate func createReferenceNode(_ dict: Dictionary<String, Any>) -> SCNNode {
    ...
    let scnReferenceNode = SCNReferenceNode(url: referenceUrl)
